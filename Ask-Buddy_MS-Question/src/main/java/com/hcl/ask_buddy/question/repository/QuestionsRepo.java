...
public interface QuestionsRepo extends JpaRepository<Question, Long>{
	...
	@Query("select ques from Question ques where ques.cat.cat_name = ?1 and ques.subCat.subcat_name = ?2")
	public List<Question> getQuestionList(String cat, String subcat);
